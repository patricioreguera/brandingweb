const Navegator = () => {
	return (
		<div className="flex flex-col items-center justify-center w-96">
			<div className="h-80 w-full rounded-xl border border-bordergray bg-pureBlack drop-shadow-[0_15px_35px_#6D28D940] transition-all duration-1000 hover:drop-shadow-[0_15px_35px_#6D28D970]">
